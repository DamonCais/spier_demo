...
service.post('https://mp-dev.guzzu.cn/mpapi/2/Product.find', obj).then(res => {
    res.data.results.forEach(element => {

        service.post('https://mp-dev.guzzu.cn/mpapi/2/Product.update', { isArchived: true, productId: element._id, storeId: '5b1100f0ee75535cac0d30d2' }).then(() => {
            console.log(element._id + 'success')
        })
